  ...
  return (
    <div
      className={[
        ...
        compact ? "min-h-[290px] sm:min-h-[360px] lg:min-h-[450px]" : "min-h-[340px] sm:min-h-[500px] lg:min-h-[620px]",
      ].join(" ")}
      aria-label="Interactive sealed capsule visualization"
      onMouseMove={(event) => {
    ...
    >
      ...
      <div className="hero-depth-glow absolute left-1/2 top-1/2 h-[22rem] w-[22rem] -translate-x-1/2 -translate-y-1/2 rounded-full sm:h-[34rem] sm:w-[34rem]" />

      {/* Outermost ring — very soft */}
      <div className="absolute left-1/2 top-1/2 h-[17rem] w-[17rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-100/[0.04] sm:h-[32rem] sm:w-[32rem]" />

      {/* Orbital rings — softer outer, sharper inner */}
      <div className="orbital-ring orbital-ring-a absolute left-1/2 top-1/2 h-[15rem] w-[15rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-100/[0.08] sm:h-[28rem] sm:w-[28rem]" />
      <div className="orbital-ring orbital-ring-b absolute left-1/2 top-1/2 h-[11rem] w-[19rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-violet-100/[0.07] sm:h-[22rem] sm:w-[36rem]" />
      <div className="orbital-ring orbital-ring-c absolute left-1/2 top-1/2 h-[8rem] w-[20rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/[0.05] sm:h-[15rem] sm:w-[40rem]" />
      <div className="orbital-ring orbital-ring-d absolute left-1/2 top-1/2 h-[18rem] w-[8rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-100/[0.06] sm:h-[28rem] sm:w-[12rem]" />
      <div className="orbital-ring orbital-ring-e absolute left-1/2 top-1/2 h-[7rem] w-[16rem] -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-100/[0.1] sm:h-[8rem] sm:w-[21rem]" />
      ...
      <div className="capsule-core absolute left-1/2 top-1/2 z-20 h-[18rem] w-[8.8rem] -translate-x-1/2 -translate-y-1/2 overflow-hidden border border-cyan-100/20 bg-[#06111b]/80 shadow-[0_0_90px_rgba(64,221,255,0.2)] backdrop-blur-[3px] sm:h-[28rem] sm:w-[13.2rem]">
        ...
        {/* Internal panels */}
        <div className="absolute inset-x-5 top-7 h-16 rounded-[4px] border border-cyan-100/12 bg-cyan-100/[0.035] sm:inset-x-6 sm:h-24" />
        <div className="absolute inset-x-5 bottom-8 h-20 rounded-[4px] border border-violet-100/[0.08] bg-violet-100/[0.03] sm:inset-x-6 sm:h-28" />
        ...
        <div className="capsule-lens absolute left-1/2 top-1/2 h-24 w-24 -translate-x-1/2 -translate-y-1/2 rounded-full border border-cyan-100/18 bg-cyan-100/[0.06] shadow-[0_0_60px_rgba(64,221,255,0.22)] sm:h-32 sm:w-32" />
        ...
        {/* Data lines */}
        <div className="data-lines absolute inset-x-7 top-28 grid gap-3 sm:inset-x-8 sm:top-40">
          <span />
          <span />
          <span />
          <span />
